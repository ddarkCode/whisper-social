...
function Header() {
  ...
  const navLikns = smallerScreen ? (
    <ul className="smaller-screen">
      ...
      <svg
        onClick={() => setSmallerScreen(!smallerScreen)}
        className="cancel"
  ...
  return (
    <header style={headerStyle}>
      <div
        ...
        style={{ position: smallerScreen ? 'relative' : 'static' }}
      >
        <div
          className="home"
          style={{ display: smallerScreen ? 'none' : 'block' }}
        >
          <Link to="/">
            <img src="/images/whisper.jpg" alt="Whisper Icon" />
          </Link>
        </div>
        {navLikns}
      </div>
